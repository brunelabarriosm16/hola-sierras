...
const getInstituciones = unstable_cache(
  async () => {
    const { data } = await supabaseServer
      .from("instituciones")
      .select("id, nombre, descripcion, premium_detalle, premium_galeria, premium_activo, direccion, localidad, telefono, web_url, instagram_url, facebook_url, foto, estado, usa_whatsapp")
